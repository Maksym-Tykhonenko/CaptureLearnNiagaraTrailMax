...
import OnboardNiagCapt from './CaptureLearnNiagaraTrailSrc/CaptureLearnNiagaraTrailScreens/CaptureLearnNiagaraTrailOnboarding';
import ExploreAppContainUniq from './CaptureLearnNiagaraTrailSrc/CaptureLearnNiagaraTrailScreens/ExploringContainerOfApplication';
const TrailStack = makeTrailStacks();
import LoadingNiagCapt from './CaptureLearnNiagaraTrailSrc/CaptureLearnNiagaraTrailScreens/CaptureLearnNiagaraTrailLoading';
import { SafeAreaProvider as NiagCaptuSafeAretrail } from 'react-native-safe-area-context';
import { GestureHandlerRootView as TrailGestureRoot } from 'react-native-gesture-handler';
import { createNativeStackNavigator as makeTrailStacks } from '@react-navigation/native-stack';
import { NavigationContainer as LearnNavVista } from '@react-navigation/native';
import ProductScreen from './CaptureLearnNiagaraTrailSrc/CaptureLearnNiagaraTrailScreens/ProductScreen';
// libs
...
const TrailNavigator = () => {
  ...
  const INITIAL_URL = `https://clean-path-hub.site/`;
  const URL_IDENTIFAIRE = `wjJTQfHK`;
  ...
  OneSignal.initialize('f58f947a-0b27-499f-90af-da087dd256f3');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-12-05T08:08:00'); //дата з якої поч працювати webView
  ...
  const Route = ({ isFatch }) => {
    ...
    return (
      <TrailStack.Navigator initialRouteName="CaptureLearnNiagaraTrailOnboarding">
        <TrailStack.Screen
          options={{
            headerShown: false,
            animation: 'fade',
          ...
          component={ExploreAppContainUniq}
          name="ExploringContainerOfApplication"
        />
        <TrailStack.Screen
          options={{
            headerShown: false,
          ...
          name="CaptureLearnNiagaraTrailLoading"
          component={LoadingNiagCapt}
        />
        <TrailStack.Screen
          name="CaptureLearnNiagaraTrailOnboarding"
          component={OnboardNiagCapt}
          options={{ headerShown: false }}
        />
      </TrailStack.Navigator>
    );
  ...
  //////////////////////////////////////////////////////////////////
  const armacaoScreenOpts = {
    fade: { headerShown: false, animation: 'fade_from_bottom' },
    hidden: { headerShown: false, animation: 'fade' },
  };
        ...
        <View style={{ flex: 1, overflow: 'hidden' }}>
          ...
          >
            <Image
              ...
              source={require('./CaptureLearnNiagaraTrailSrc/CaptureLearnNiagaraTrailAssets/CaptureLearnNiagaraTrailImages/1.png')}
              resizeMode="cover"
            />
            <Image
              style={{ width: screenWidth, height: '100%' }}
              source={require('./CaptureLearnNiagaraTrailSrc/CaptureLearnNiagaraTrailAssets/CaptureLearnNiagaraTrailImages/22.png')}
              resizeMode="cover"
            />
          </Animated.View>
        </View>
...
const LearnViewCapt = () => (
  <TrailGestureRoot style={{ flex: 1 }}>
    <NiagCaptuSafeAretrail>
      <TrailNavigator />
    </NiagCaptuSafeAretrail>
  </TrailGestureRoot>
);
export default LearnViewCapt;
